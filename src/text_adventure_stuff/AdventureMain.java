...
public class AdventureMain {
	...
	private void lookAtRoom(boolean b) {
	...
	boolean parseCommand(String text) {
		...
		//String word2 = words[1];  But we have to make sure that this array element exists
	...
	private void eatItem(String word2) {
	...
	private void moveToRoom(char charAt) {
